    ...
    <ul className="flex flex-col gap-1.5">
      {materials.map((m) => (
        <li key={m.mattype} className="flex items-center gap-2">
          ...
          />
          <span className="shrink-0 text-sm font-medium text-neutral-700">mattype {m.mattype}</span>
          <input
            type="text"
            placeholder="label"
            ...
            className="min-w-0 flex-1 rounded border border-neutral-200 px-1.5 py-0.5 text-xs focus:border-violet-500 focus:outline-none"
          />
